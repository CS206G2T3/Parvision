  ...
  return (
    <div className="flex-1 overflow-y-auto pb-8">
      ...
      <div className="mx-5 mt-6 flex gap-3">
        <button onClick={() => navigate('/community', { state: { draft: { type: 'ball-tracer', caption: 'Check out my ball trace! 🏌️ #BallTracer', tag: 'Ball Tracer' } } })} className="flex-1 flex items-center justify-center gap-2 h-[48px] bg-[#248a3d] rounded-2xl active:opacity-80">
